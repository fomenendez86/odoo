...
class TestQWebNS(TransactionCase):
    ...
    def test_render_static_xml_with_void_element(self):
        ...
        self.assertEqual(etree.fromstring(rendering, parser=lxml.etree.XMLParser(resolve_entities=False)), etree.fromstring(expected_result, parser=lxml.etree.XMLParser(resolve_entities=False)))
